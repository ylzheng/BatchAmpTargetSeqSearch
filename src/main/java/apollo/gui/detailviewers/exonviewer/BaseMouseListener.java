  ...
  */
  ...
  public void mousePressed(MouseEvent e) {
    ...
    if (dragStartPos == -1) {
      ...
      if(dragFeature != null) 
        goodUser = baseEditorPanel.testUser(((AnnotatedFeatureI) dragFeature.getRefFeature()).getOwner());
      
      if (!goodUser || (dragFeature == null && ((dragType != baseEditorPanel.SEQ_SELECT_DRAG) ||
