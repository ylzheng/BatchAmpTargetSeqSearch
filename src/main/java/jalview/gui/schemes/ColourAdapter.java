...
public class ColourAdapter {
  ...
  public static ColourSchemeI get(String scheme) { //MG ColourScheme->ColourSchemeI
    if (ColourProperties.contains(scheme)) {
      if (ColourProperties.indexOf(scheme) == ColourProperties.ZAPPO) {
        ...
        return null;//MG  new ClustalxColourScheme();
      }
    } else {
  ...
  public static ColourSchemeI get(int scheme) { //MG ColourScheme->ColourSchemeI 
  ...
  public static int get(ColourScheme cs) {
    if (cs instanceof ZappoColourScheme) {
      return 0;
      ...
      return 4;
    } else if (cs instanceof SecondaryColourScheme) {
      return 5;
    } else if (cs instanceof ConservationColourScheme) {
      return 6;
      ...
      return 11;
    } else if (cs instanceof FeatureColourScheme) {
      return 12;
