...
public class ClustalwThread extends CommandThread {
  ...
  public ClustalwThread(AlignSequenceI[] s) {
    ...
    try {
      ...
      do {
        ...
        inFile  = prefix + "clustal" + r1str + ".msf";
        outFile = prefix + "clustal" + r1str + ".aln";
  ...
  public void run() {
    ...
    try {
      ...
      while((len = is.read(buf)) != -1 ) {
        ...
        if (str.indexOf("CLUSTAL-Alignment file created") >= 0)
          break;
