...
public class AlignSeq {
  ...
  public AlignSeq(AlignSequenceI s1, AlignSequenceI s2,String type) {
  ...
  public AlignSequenceI getS1() {
    return s1;
  }
  public AlignSequenceI getS2() {
    return s2;
  }

  public void SeqInit(AlignSequenceI s1, AlignSequenceI s2,String type) {
    System.out.println(s1.getResidues());
    System.out.println(s2.getResidues());
    s1str = extractGaps(".",s1.getResidues());
    s2str = extractGaps(".",s2.getResidues());
